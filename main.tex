...
\titulo{Smaller Rainbow key pairs}
...
recovering private keys, for instance, RSA\sigla{RSA}{Rivest-Shamir-Adleman}
and ECDSA\sigla{ECDSA}{Elliptic Curve Digital Signature Algorithm} keys, relies
...
(IP)\sigla{IP}{Isomorphism of Polynomials} problem.
...
(OV)\sigla{OV}{Oil and Vinegar} signature scheme~\cite{patarin1997ov}, which
...
leading to a scheme called Unbalanced Oil-Vinegar (UOV)\sigla{UOV}{Unbalanced
Oil and Vinegar}. The classic OV is the building block for various other
