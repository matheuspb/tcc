...
\agradecimento{Agradeço aos meus pais que me fizeram capazes de entender e
...
esse trajeto. Em especial, agradeço ao Lucas e ao Vinícius que sempre me
...
pós-quântica. Tais esquemas possuem tamanhos de chaves muito maiores que os
algoritmos clássicos. Neste trabalho um novo método para redução de chaves
privadas do esquema de assinatura digital Rainbow é proposto. Usando este
método as chaves privadas podem ser reduzidas em até 84\%. Ainda, este método
pode ser combinado com outros de forma a reduzir o par de chaves por completo.}
...
has raised as well. The area that studies such cryptosystems is therefore
called post-quantum cryptography. Particularly, these algorithms are based upon
a series of problems that continue to be hard, even with quantum computers
available, hence, provoke interest to substitute the classical schemes. This
work aims to study the cryptosystems based on systems of multivariate
...
quantum computers, henceforth are good candidates to post-quantum cryptography.
...
up to 84\%. Still, this method can be combined with others to achieve smaller
key pairs in their entirety.}
